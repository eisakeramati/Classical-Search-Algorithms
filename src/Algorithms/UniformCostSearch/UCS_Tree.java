...
public class UCS_Tree extends Algorithm {

    ArrayList<Problem.State> openStates;
    long start, end;

    public UCS_Tree(Problem problem) {
        super(problem);
    ...
    public void run() {
        ...
        while (!openStates.isEmpty()) {
            s = getNextState();
            CityPathProblem.State ss = (CityPathProblem.State) s;
            System.out.println(ss.cityName);
           ...
           // System.out.println("in2in2in2in2in2");
